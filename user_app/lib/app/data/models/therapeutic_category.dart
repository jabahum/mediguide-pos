...
/// Therapeutic category model based on legacy collection API therapeutic_categories collection
class TherapeuticCategory extends BaseModel {
  ...
  /// Create TherapeuticCategory from legacy collection API record
