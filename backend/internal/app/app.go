...
func New(cfg config.Config) (*App, error) {
	...
	v2 := r.Group("/api/v2")
	{
		...
		protected.POST("/guideline-versions/:id/assets", middleware.RequirePermission("guideline.write"), rateLimiter.Limit(middleware.Policy("guideline-asset-upload", 60, time.Hour, 10), middleware.UserIdentity), guidelineH.CreateGuidelineAsset)
		protected.GET("/guideline-versions/:id/assets", middleware.RequirePermission("guideline.write"), guidelineH.ListGuidelineAssets)
		protected.GET("/guideline-versions/:id/assets/:assetId", middleware.RequirePermission("guideline.write"), guidelineH.GetGuidelineAsset)
		protected.GET("/guideline-versions/:id/assets/:assetId/content", middleware.RequirePermission("guideline.write"), guidelineH.ReviewAsset)
		protected.PATCH("/guideline-versions/:id/assets/:assetId", middleware.RequirePermission("guideline.write"), guidelineH.UpdateGuidelineAsset)
		protected.DELETE("/guideline-versions/:id/assets/:assetId", middleware.RequirePermission("guideline.write"), guidelineH.DeleteGuidelineAsset)
		...
		protected.GET("/guideline-versions/:id/markdown-revisions/:revisionId/validation", middleware.RequirePermission("guideline.write"), guidelineH.ValidateMarkdownRevision)
		...
		protected.GET("/guideline-versions/:id/regeneration-jobs/:jobId", middleware.RequirePermission("guideline.write"), guidelineH.GetRegenerationJob)
		protected.POST("/guideline-versions/:id/regeneration-jobs/:jobId/cancel", middleware.RequirePermission("guideline.write"), guidelineH.CancelRegenerationJob)
		protected.POST("/guideline-versions/:id/regeneration-jobs/:jobId/retry", middleware.RequirePermission("guideline.write"), guidelineH.RetryRegenerationJob)
		protected.GET("/guideline-versions/:id/regeneration-reviews/:jobId", middleware.RequirePermission("guideline.write"), guidelineH.GetRegenerationReview)
		protected.POST("/guideline-versions/:id/regeneration-reviews/:jobId/accept", middleware.RequirePermission("guideline.publish"), guidelineH.AcceptRegeneration)
		protected.POST("/guideline-versions/:id/regeneration-reviews/:jobId/reject", middleware.RequirePermission("guideline.publish"), guidelineH.RejectRegeneration)
		protected.GET("/guideline-versions/:id/regeneration-reviews/:jobId/comments", middleware.RequirePermission("guideline.write"), guidelineH.ListRegenerationComments)
		protected.POST("/guideline-versions/:id/regeneration-reviews/:jobId/comments", middleware.RequirePermission("guideline.write"), guidelineH.AddRegenerationComment)
