...
func New(cfg config.Config) (*App, error) {
	...
	v2 := r.Group("/api/v2")
	{
		...
		protected.PATCH("/notification-campaigns/:id/status", middleware.RequirePermission("notification.campaign.manage"), rateLimiter.Limit(middleware.Policy("notification-campaign-write", 10, time.Hour, 0), middleware.UserIdentity), notificationH.UpdateCampaignStatus)
