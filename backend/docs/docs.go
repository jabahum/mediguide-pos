...
const docTemplate = `{
        ...
        "/api/v2/diseases": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Return only root diseases",
                        "name": "root_only",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.PaginatedDiseasesEnvelope"
                        }
                    }
                }
            },
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Disease taxonomy entry",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/services.DiseaseInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v2/diseases/migration-report": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "matched, ambiguous, or unmatched",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.PaginatedDiseaseMigrationReportEnvelope"
                        }
                    }
                }
            }
        },
        "/api/v2/diseases/migration-report/refresh": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v2/diseases/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Disease taxonomy changes",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "handlers.PaginatedDiseaseMigrationReportEnvelope": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/services.PageResult-models_DiseaseTaxonomyMigrationReport"
                },
                "success": {
                    "type": "boolean"
                }
        ...
        "handlers.PaginatedDiseasesEnvelope": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "models.DiseaseTaxonomyMigrationReport": {
            "type": "object",
            "properties": {
        ...
        "services.PageResult-models_DiseaseTaxonomyMigrationReport": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DiseaseTaxonomyMigrationReport"
                    }
                },
                "page": {
                    "type": "integer"
