...
/// MyNotification model representing a notification from legacy collection API
class MyNotification extends BaseModel {
  ...
  /// Factory constructor to create MyNotification from legacy collection API record
