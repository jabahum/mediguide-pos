...
func New(cfg config.Config) (*App, error) {
	...
	v2 := r.Group("/api/v2")
	{
		...
		protected.PUT("/content-disease-assignments/replace", middleware.RequirePermission("guideline.write"), contentDiseaseH.Replace)
		...
		protected.GET("/content-hubs/:id/workspace", middleware.RequireAnyPermission("admin.all", "guideline.read", "outbreak.read"), contentHubH.Workspace)
		protected.GET("/content-hubs/:id/audit", middleware.RequireAnyPermission("admin.all", "guideline.read", "outbreak.read"), contentHubH.Audit)
		protected.GET("/content-hub-resources", middleware.RequireAnyPermission("admin.all", "guideline.read", "outbreak.read"), contentHubH.SearchResources)
		protected.POST("/outbreaks/:id/content-hub", middleware.RequireAnyPermission("admin.all", "outbreak.manage"), contentHubH.ConfigureOutbreak)
